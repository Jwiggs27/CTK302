...
//  lost=loadImage("assets/lost.png");
  ...
  f1=loadFont("assets/Righteous.ttf");
  imageMode(CENTER);
  rectMode(CENTER);
  noStroke();
}
...
image(monkey,50,50, 150, 150);
  ...
  textFont(f1);
  textAlign(CENTER);
  text("Eat All The Bananas", width / 2, 600, windowWidth - 200, windowHeight - 200);
...
function Car() {
  ...
  this.display = function() {
    ...
    image(banana, this.pos.x, this.pos.y - 25, 80, 80);
